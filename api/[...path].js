...
var defaultFeatureSettings = () => ({
  ...
  puzzleImageId: 0,
  uiLayout: "soft-story",
  ambientHeartsEnabled: true,
  sparklesEnabled: true,
  filmOverlayEnabled: false,
  secretGiftEnabled: true,
  secretGiftTitle: "\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E02\u0E2D\u0E07\u0E02\u0E27\u0E31\u0E0D\u0E25\u0E31\u0E1A",
  secretGiftMessage: "\u0E02\u0E2D\u0E1A\u0E04\u0E38\u0E13\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E21\u0E32\u0E43\u0E19\u0E04\u0E27\u0E32\u0E21\u0E17\u0E23\u0E07\u0E08\u0E33\u0E19\u0E35\u0E49\u0E19\u0E30 \u{1F49D}",
  easterEggEnabled: true,
  celebrationOnOpenEnabled: true,
...
async function getVisitorSiteIdBySlug(slug) {
  const { data } = await readRepository();
...
var featureInput = z2.object({
  ...
  ambientHeartsEnabled: z2.boolean().default(true),
  sparklesEnabled: z2.boolean().default(true),
  filmOverlayEnabled: z2.boolean().default(false),
  secretGiftEnabled: z2.boolean().default(true),
  secretGiftTitle: z2.string().trim().max(160).default("\u0E01\u0E25\u0E48\u0E2D\u0E07\u0E02\u0E2D\u0E07\u0E02\u0E27\u0E31\u0E0D\u0E25\u0E31\u0E1A"),
  secretGiftMessage: z2.string().trim().max(1500).default("\u0E02\u0E2D\u0E1A\u0E04\u0E38\u0E13\u0E17\u0E35\u0E48\u0E40\u0E02\u0E49\u0E32\u0E21\u0E32\u0E43\u0E19\u0E04\u0E27\u0E32\u0E21\u0E17\u0E23\u0E07\u0E08\u0E33\u0E19\u0E35\u0E49\u0E19\u0E30 \u{1F49D}"),
  easterEggEnabled: z2.boolean().default(true),
  celebrationOnOpenEnabled: z2.boolean().default(true),
  soundEffectsEnabled: z2.boolean().default(true),
  soundEffectsVolume: z2.number().min(0).max(1).default(0.35),
