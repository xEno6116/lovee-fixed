...
export default function Home({ slug }: { slug: string }) {
  ...
  const openPhotoPuzzle = () => { if (!photos.length) return; setPuzzleOrder(makePuzzleOrder()); setSelectedPuzzleTile(null); setPuzzleOpened(true); };
