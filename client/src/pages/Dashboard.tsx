...
export default function Dashboard() {
  ...
  const createMutation = trpc.site.dashboard.create.useMutation({
    onSuccess: (site) => { void utils.site.dashboard.list.invalidate(); setLocation(ownerSettingsPath(site.slug)); },
